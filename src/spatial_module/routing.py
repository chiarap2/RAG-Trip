...
# %%
def routing_graphhopper(lonStart, latStart, lonEnd, latEnd, mode='foot', graphhopper_api_key=None, number_of_routes=1):
    """
    ...
    routes = client.directions(
        ...
        alternative_route_max_paths=number_of_routes,
